  ...
  return (
    <Box
      sx={{
        ...
        marginTop: { xs: "56px", sm: "74px" },
        height: "calc(100vh - 64px)",
        overflow: "hidden",
      }}
    >
      {/* Left Section */}
      <Box sx={{ flex: 4, display: 'flex', flexDirection: 'column', gap: 3 }}>
        {/* Header Section */}
        ...
        {/* Search and Payment Status Section */}
        <Box>
          <TextField
            fullWidth
            size="small"
            ...
            <Card key={item} sx={{ mb: 2 }}>
              <CardContent sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                  ...
                  />
                  <Box>
                    <Typography variant="subtitle1">Rose Garden Restaurant</Typography>
      ...
      {/* Right Section */}
      <Box sx={{ flex: 7, display: 'flex', flexDirection: 'column', gap: 3 }}>
        {/* Summary Card */}
        <Card>
          <CardContent>
